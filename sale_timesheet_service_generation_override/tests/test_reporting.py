...
class TestReporting(TestCommonSaleTimesheetNoChart):
    ...
    def test_profitability_report(self):
        ...
        self.assertTrue(
            float_is_zero(
                project_global_stat["amount_untaxed_invoiced"], precision_rounding=rounding
            ),
            "The invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["amount_untaxed_to_invoice"], precision_rounding=rounding
            ),
            "The amount to invoice of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_global_stat["timesheet_unit_amount"], precision_rounding=rounding
            ),
            "The timesheet unit amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_global_stat["timesheet_cost"], precision_rounding=rounding),
        ...
        self.assertTrue(
            float_is_zero(
                project_global_stat["expense_amount_untaxed_invoiced"], precision_rounding=rounding
            ),
            "The expense invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_global_stat["expense_cost"], precision_rounding=rounding),
        ...
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_invoiced"], precision_rounding=rounding
            ),
            "The invoiced amount of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["amount_untaxed_to_invoice"], precision_rounding=rounding
            ),
            "The amount to invoice of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_so_1_stat["timesheet_unit_amount"], precision_rounding=rounding),
            "The timesheet unit amount of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_so_1_stat["timesheet_cost"], precision_rounding=rounding),
            "The timesheet cost of the global project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_amount_untaxed_to_invoice"], precision_rounding=rounding
            ),
            "The expense cost to reinvoice of the project from SO1 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_1_stat["expense_amount_untaxed_invoiced"], precision_rounding=rounding
            ),
            "The expense invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_so_1_stat["expense_cost"], precision_rounding=rounding),
        ...
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["amount_untaxed_invoiced"], precision_rounding=rounding
            ),
        ...
        self.assertEqual(
            float_compare(
                ...
                self.so_line_order_project.price_unit * self.so_line_order_project.qty_to_invoice,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertTrue(
            float_is_zero(project_so_2_stat["timesheet_unit_amount"], precision_rounding=rounding),
            "The timesheet unit amount of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_so_2_stat["timesheet_cost"], precision_rounding=rounding),
            "The timesheet cost of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["expense_amount_untaxed_to_invoice"], precision_rounding=rounding
            ),
            "The expense cost to reinvoice of the project from SO2 should be 0.0",
        )
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["expense_amount_untaxed_invoiced"], precision_rounding=rounding
            ),
            "The expense invoiced amount of the global project should be 0.0",
        )
        self.assertTrue(
            float_is_zero(project_so_2_stat["expense_cost"], precision_rounding=rounding),
        ...
        self.assertEqual(
            float_compare(
                ...
                self.so_line_deliver_project.price_unit * project_so_1_timesheet_sold_unit,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                ...
                project_so_1_timesheet_sold_unit + timesheet1.unit_amount,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                ...
                project_so_2_timesheet_sold_unit + timesheet2.unit_amount,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertEqual(
            float_compare(
                ...
                self.so_line_order_project.price_unit * self.so_line_order_project.product_uom_qty,
                precision_rounding=rounding,
            ),
            0,
        ...
        self.assertTrue(
            float_is_zero(
                project_so_2_stat["amount_untaxed_to_invoice"], precision_rounding=rounding
            ),
        ...
        self.assertEqual(
            float_compare(
                project_so_1_stat["expense_cost"], expense1.amount, precision_rounding=rounding
            ),
            0,
            "The expense cost of the project from SO1 should be 0.0",
        )
        ...
        self.assertEqual(
            float_compare(
                project_global_stat["expense_cost"], expense2.amount, precision_rounding=rounding
            ),
            0,
            "The expense cost of the global project should be 0.0",
        )
