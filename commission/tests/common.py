...
class TestCommissionCase(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.company_data = cls.setup_company_data('Company_name_1', chart_template=chart_template)
    ...
    #     account_chart = cls.env.ref('l10n_generic_coa.configurable_chart_template', raise_if_not_found=False)
    #     chart_template = account_chart or cls.env.company.chart_template_id
